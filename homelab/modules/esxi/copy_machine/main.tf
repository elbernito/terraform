...
#  ESXI Guest resource
#########################################
resource "esxi_guest" "copy_machine" {
  guest_name = "copy_machine"
...
resource "ansible_playbook" "configure_ip" {
  ...
  extra_vars = {
    ...
    ansible_hostname     = "${esxi_guest.copy_machine.ip_address}"
...
resource "ansible_playbook" "check_ip" {
  depends_on = [esxi_guest.copy_machine, ansible_playbook.configure_ip]
  # =========================================================
  # name has set to ip or host name! Plugin will use this
  # in the ssh command as host... :/
  # =========================================================
